...
| **运营记录层** | 飞书多维表格：记录标题、状态、发布日期、复盘字段 | **可选** |

> 也就是说，第一次上手只需要先理解方法层；需要自动抓取/推草稿时再接执行层；Obsidian / IMA / 乐享 和飞书多维表格都属于后续增强，不应该阻塞第一次使用。
...
`Phase 6` 的飞书多维表格更适合放在“运营记录层”理解：

- 记录标题、发布日期、字数、状态、排版方式
- 适合做发稿台账、复盘回看、团队协作同步
- 默认也是增强项，不是首次安装前置条件
